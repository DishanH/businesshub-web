...
import NannyGrid from "./NannyGrid"

export default function NanniesPageClient() {
  const [activeFilters, setActiveFilters] = useState<string[]>(["specialties", "availability"]);
  
  const resetFilters = () => {
    // Reset all form elements (this would be expanded with actual form state in a real implementation)
    setActiveFilters(["specialties", "availability"]);
    // You would also reset checkboxes, radio buttons, and slider values here
    
    // For demonstration purposes, we'll just log that filters were reset
    ...
    <div className="container py-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div className="flex flex-wrap gap-3">
          <Button asChild variant="secondary" className="font-medium shadow-sm">
            <Link href="/nannies/favorites">
              <Heart className="mr-2 h-4 w-4" />
              Liked Nannies
            </Link>
          </Button>
          <Button asChild variant="default" className="bg-primary text-primary-foreground hover:bg-primary/90 font-medium shadow-sm">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/4 space-y-6">
          <div className="bg-card rounded-lg border shadow-sm p-6">
            ...
            <Accordion type="multiple" className="w-full" defaultValue={activeFilters}>
              {/* Rating Filter - Hidden as requested */}
            ...
            <Button className="w-full mt-6 bg-primary text-primary-foreground hover:bg-primary/90 font-medium shadow-sm">
              Apply Filters
            </Button>
          </div>
        </div>
